...
INSERT INTO `job` (`id`,`job_date`,`job_detail`,`job_start_date`,`job_success_date`,`job_how_to_fix`,`price`,`job_status`,`job_employee_id`,`job_type_id`,`device_id`,`user_id`) VALUES
('221','2016-12-28 09:37:46','คอมพิวเตอร์ห้อง ๙๔๐๑ ไม่รองรับการเปิดดู Youtube แบบเต็มจอ','','','ตั้งค่าหน้าจอ Notebook 1280*768  หรือ น้อยกว่าก็ได้ ครับ 800*600 ภาพจะได้เต็มพอดี','0','wait','9','9','120','6');
INSERT INTO `job` (`id`,`job_date`,`job_detail`,`job_start_date`,`job_success_date`,`job_how_to_fix`,`price`,`job_status`,`job_employee_id`,`job_type_id`,`device_id`,`user_id`) VALUES
