...
ขอใช้ ืnot book 1 ตัว เครื่องเสียง ไมลลอย 2 ตัว โปรเจคเตอร์ กล้องถ่ายรูป 1 ส่วนวันที่ ๒๔ ใช้แค่ไมล์ลอย 2 ตัวคะ','','','','','wait','33','','','');
INSERT INTO `job` (`id`,`job_date`,`job_detail`,`job_start_date`,`job_success_date`,`job_how_to_fix`,`price`,`job_status`,`job_employee_id`,`job_type_id`,`device_id`,`user_id`) VALUES
('362','2017-03-07 10:00:00','ขอใช้อุปกรณ์โสตฯ note book  2017-03-07 14:00 เป็นต้นไป ประชุมเรื่องขั้นขึ้นเงินเดือน ห้องประชุมดอกบัว','','','','','wait','40','','','');
