...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            'fullname'          => Yii::t('user', 'ชื่อ - นามสถุล'),
            ...
            'role'              => Yii::t('user', 'สิทธิ์การใช้งานระบบ'),
        ];
    }
    ...
    {
        return [
            'register' => ['username','email',  'position', 'password'],
            'connect'  => ['username', 'email'],
            'create'   => ['fullname','email', 'username', 'position', 'password','role'],
            'update'   => ['fullname','email', 'username', 'position', 'password','role'],
            'settings' => ['username', 'email','position', 'password'],
        ];
    }
    ...
    public function rules()
    {
        return [
            ...
            'fullnameRequired' => ['fullname', 'required', 'on' => ['register', 'create', 'connect', 'update']],
            'positionRequired' => ['position', 'required', 'on' => ['register', 'create', 'connect', 'update']],
            ...
            'roleRequired' => ['role', 'required', 'on' => ['register', 'create', 'connect', 'update']],
        ];
    }
